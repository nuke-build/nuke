...
namespace Nuke.GlobalTool
{
    partial class Program
    {
        ...
        public static int AddPackage(string[] args, [CanBeNull] AbsolutePath rootDirectory, [CanBeNull] AbsolutePath buildScript)
        {
            ...
            var hasToolsDirectory = NuGetPackageResolver.GetGlobalInstalledPackage(packageId, packageVersion, packagesConfigFile: null)
                .NotNull("installedPackage != null")
                .Directory.GlobDirectories("tools").Any();
