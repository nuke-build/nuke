...
public abstract partial class ToolTasks
{
    ...
    protected virtual partial IReadOnlyCollection<Output> Run<T>(ToolOptions options = null) where T : ToolOptions, new();
    protected virtual partial (TResult Result, IReadOnlyCollection<Output> Output) Run<TOptions, TResult>(ToolOptions options = null) where TOptions : ToolOptions, new();
