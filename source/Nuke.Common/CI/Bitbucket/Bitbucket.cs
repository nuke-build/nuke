...
namespace Nuke.Common.CI.Bitbucket
{
    ...
    public class Bitbucket : Host, IBuildServer
    {
        ...
        /// </summary>
        public string CloneDirectory => EnvironmentInfo.GetVariable<string>("BITBUCKET_CLONE_DIR");

        /// <summary>
        /// The commit hash of a commit that kicked off the build.
        /// </summary>
        public string Commit => EnvironmentInfo.GetVariable<string>("BITBUCKET_COMMIT");

        /// <summary>
        /// The name of the workspace in which the repository lives.
        /// </summary>
        public string Workspace => EnvironmentInfo.GetVariable<string>("BITBUCKET_WORKSPACE");

        /// <summary>
        /// The URL-friendly version of a repository name.
        /// </summary>
        public string RepositorySlug => EnvironmentInfo.GetVariable<string>("BITBUCKET_REPO_SLUG");

        /// <summary>
        /// The UUID of the repository.
        /// </summary>
        public string RepositoryUuid => EnvironmentInfo.GetVariable<string>("BITBUCKET_REPO_UUID");

        /// <summary>
        /// The full name of the repository (everything that comes after http://bitbucket.org/).
        /// </summary>
        public string RepositoryFullName => EnvironmentInfo.GetVariable<string>("BITBUCKET_REPO_FULL_NAME");

        /// <summary>
        /// The source branch. This value is only available on branches. Not available for builds against tags, or custom pipelines.
        /// </summary>
        public string Branch => EnvironmentInfo.GetVariable<string>("BITBUCKET_BRANCH");
        ...
        /// </summary>
        public string Tag => EnvironmentInfo.GetVariable<string>("BITBUCKET_TAG");

        /// <summary>
        /// For use with Mercurial projects.
        /// </summary>
        public string Bookmark => EnvironmentInfo.GetVariable<string>("BITBUCKET_BOOKMARK");
        ...
        /// </summary>
        public string PullRequestDestinationBranch => EnvironmentInfo.GetVariable<string>("BITBUCKET_PR_DESTINATION_BRANCH");

        /// <summary>
        /// The URL for the origin, for example: http://bitbucket.org/&lt;account&gt;/&lt;repo&gt;
        /// </summary>
        public string GitHttpOrigin => EnvironmentInfo.GetVariable<string>("BITBUCKET_GIT_HTTP_ORIGIN");

        /// <summary>
        /// Your SSH origin, for example: git@bitbucket.org:/&lt;account&gt;/&lt;repo&gt;.git
        /// </summary>
        public string GitSshOrigin => EnvironmentInfo.GetVariable<string>("BITBUCKET_GIT_SSH_ORIGIN");

        /// <summary>
        /// The exit code of a step, can be used in after-script sections. Values can be 0 (success) or 1 (failed)
        /// </summary>
        public string ExitCode => EnvironmentInfo.GetVariable<string>("BITBUCKET_EXIT_CODE");

        /// <summary>
        /// The UUID of the step.
        /// </summary>
        public string StepUuid => EnvironmentInfo.GetVariable<string>("BITBUCKET_STEP_UUID");

        /// <summary>
        ///  The UUID of the pipeline.
        /// </summary>
        public string PipelineUuid => EnvironmentInfo.GetVariable<string>("BITBUCKET_PIPELINE_UUID");

        /// <summary>
        /// The URL friendly version of the environment name.
        /// </summary>
        public string DeploymentEnvironment => EnvironmentInfo.GetVariable<string>("BITBUCKET_DEPLOYMENT_ENVIRONMENT");

        /// <summary>
        /// The UUID of the environment to access environments via the REST API.
        /// </summary>
        public string DeploymentEnvironmentUuid => EnvironmentInfo.GetVariable<string>("BITBUCKET_DEPLOYMENT_ENVIRONMENT_UUID");

        /// <summary>
        /// The key of the project the current pipeline belongs to.
        /// </summary>
        public string ProjectKey => EnvironmentInfo.GetVariable<string>("BITBUCKET_PROJECT_KEY");

        /// <summary>
        /// The UUID of the project the current pipeline belongs to.
        /// </summary>
        public string ProjectUuid => EnvironmentInfo.GetVariable<string>("BITBUCKET_PROJECT_UUID");

        /// <summary>
        /// The person who kicked off the build ( by doing a push, merge etc), and for scheduled builds, the uuid of the pipelines user.
        /// </summary>
        public string StepTriggererUuid => EnvironmentInfo.GetVariable<string>("BITBUCKET_STEP_TRIGGERER_UUID");
        ...
        /// </summary>
        public string StepOidcToken => EnvironmentInfo.GetVariable<string>("BITBUCKET_STEP_OIDC_TOKEN");
    }
}
