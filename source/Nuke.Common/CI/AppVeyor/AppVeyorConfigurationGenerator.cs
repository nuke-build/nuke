...
namespace Nuke.Common.CI.AppVeyor
{
    ...
    /// </summary>
    [PublicAPI]
    public class AppVeyorConfigurationGenerator : ConfigurationGeneratorBase
    {
        private readonly AppVeyorImage[] _images;

        public AppVeyorConfigurationGenerator(AppVeyorImage image, params AppVeyorImage[] images)
            : this(new[] { image }.Concat(images))
        {
        }

        internal AppVeyorConfigurationGenerator(IEnumerable<AppVeyorImage> images)
        {
