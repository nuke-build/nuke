...
namespace Nuke.Common.CI.GitHubActions
{
    ...
    /// </summary>
    [PublicAPI]
    public class GitHubActionsConfigurationGenerator : ConfigurationGeneratorBase
    {
        private readonly string _name;
        private readonly GitHubActionsImage[] _images;

        public GitHubActionsConfigurationGenerator(
            string name,
            GitHubActionsImage image,
            params GitHubActionsImage[] images)
            : this(name, new[] { image }.Concat(images))
        {
        }

        internal GitHubActionsConfigurationGenerator(
            string name,
            IEnumerable<GitHubActionsImage> images)
        {
            _name = name;
        ...
        {
            var configuration = new Configuration.GitHubActionsConfiguration
                                {
                                    Name = _name,
                                    ShortTriggers = On,
