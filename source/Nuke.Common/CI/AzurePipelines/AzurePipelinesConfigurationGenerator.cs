...
{
    [PublicAPI]
    public class AzurePipelinesConfigurationGenerator : ChainedConfigurationBase
    {
        private readonly string _suffix;
        private readonly AzurePipelinesImage[] _images;

        public AzurePipelinesConfigurationGenerator(
        ...
        public AzurePipelinesConfigurationGenerator(
            ...
            AzurePipelinesImage image,
            params AzurePipelinesImage[] images)
            : this(suffix, new[] { image }.Concat(images))
        {
        }

        protected internal AzurePipelinesConfigurationGenerator(
            [CanBeNull] string suffix,
            IEnumerable<AzurePipelinesImage> images)
        {
            _suffix = suffix;
