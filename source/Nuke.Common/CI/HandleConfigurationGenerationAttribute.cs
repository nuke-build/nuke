...
namespace Nuke.Common.CI
{
    ...
    public class HandleConfigurationGenerationAttribute : Attribute, IOnBeforeLogo, IOnAfterLogo, IOnBuildFinished
    {
        ...
        {
            return build.GetType().GetCustomAttributes<ConfigurationGeneratorAttributeBase>();
        }
            ...
            IReadOnlyCollection<ExecutableTarget> executableTargets)
        {
            ...
            writer.WriteComment();
            writer.WriteComment(
                $"        [{generator.GetType().Name.TrimEnd(nameof(Attribute))} ({nameof(IConfigurationGenerator.AutoGenerate)} = false)]");
            writer.WriteComment();
            writer.WriteComment("    - To trigger manual generation invoke:");
            writer.WriteComment();
            writer.WriteComment($"        nuke --{ConfigurationParameterName} {generator.Id}- --host {generator.HostType}");
