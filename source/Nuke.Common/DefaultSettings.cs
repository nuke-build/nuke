...
namespace Nuke.Common
{
    ...
    public class DefaultSettings
    {
        ...
        public static GitVersionSettings GitVersion => new GitVersionSettings ()
                .SetWorkingDirectory (Build.Instance.RootDirectory.AssertNotNull ("Build.Instance.RootDirectory != null"));
        ...
        public static GitLink2Settings GitLink2 => new GitLink2Settings ()
                .SetWorkingDirectory (Build.Instance.RootDirectory.AssertNotNull ("Build.Instance.RootDirectory != null"))
                .SetSolutionDirectory (Build.Instance.SolutionDirectory.AssertNotNull ("Build.Instance.SolutionDirectory != null"))
                .SetConfiguration (Build.Instance.Configuration)
                .SetBranchName (GitHubBuild.Instance.GitVersion.AssertNotNull ("GitHubBuild.Instance.GitVersion != null").BranchName)
                .SetRepositoryUrl (GitHubBuild.Instance.GitRepositoryUrl.AssertNotNull ("GitHubBuild.Instance.GitRepositoryUrl != null").SvnUrl);

        public static GitLink3Settings GitLink3 => new GitLink3Settings ()
                .SetWorkingDirectory (Build.Instance.RootDirectory.AssertNotNull ("Build.Instance.RootDirectory != null"))
                .SetBaseDirectory (Build.Instance.RootDirectory.AssertNotNull ("Build.Instance.RootDirectory != null"))
                .SetRepositoryUrl (GitHubBuild.Instance.GitRepositoryUrl.AssertNotNull ("GitHubBuild.Instance.GitRepositoryUrl != null").SvnUrl);
    }
}