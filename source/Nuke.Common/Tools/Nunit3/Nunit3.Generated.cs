...
namespace Nuke.Common.Tools.Nunit3
{
    ...
    public static partial class Nunit3SettingsExtensions
    {
        ...
        /// <summary><p><i>Clears <see cref="Nunit3Settings.InputFiles"/>.</i></p><p>The console program must always have an assembly or project specified. Assemblies are specified by file name or path, which may be absolute or relative. Relative paths are interpreted based on the current directory.</p><p>In addition to assemblies, you may specify any project type that is understood by NUnit. Out of the box, this includes various Visual Studio project types as well as NUnit (.nunit) test projects (see <a href="https://github.com/nunit/docs/wiki/NUnit-Test-Projects">NUnit Test Projects</a> for a description of NUnit test projects).</p><p>If the NUnit V2 framework driver is installed, test assemblies may be run based on any version of the NUnit framework beginning with 2.0. Without the V2 driver, only version 3.0 and higher tests may be run.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Adds a single inputFile to <see cref="Nunit3Settings.InputFiles"/>.</i></p><p>The console program must always have an assembly or project specified. Assemblies are specified by file name or path, which may be absolute or relative. Relative paths are interpreted based on the current directory.</p><p>In addition to assemblies, you may specify any project type that is understood by NUnit. Out of the box, this includes various Visual Studio project types as well as NUnit (.nunit) test projects (see <a href="https://github.com/nunit/docs/wiki/NUnit-Test-Projects">NUnit Test Projects</a> for a description of NUnit test projects).</p><p>If the NUnit V2 framework driver is installed, test assemblies may be run based on any version of the NUnit framework beginning with 2.0. Without the V2 driver, only version 3.0 and higher tests may be run.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Removes a single inputFile from <see cref="Nunit3Settings.InputFiles"/>.</i></p><p>The console program must always have an assembly or project specified. Assemblies are specified by file name or path, which may be absolute or relative. Relative paths are interpreted based on the current directory.</p><p>In addition to assemblies, you may specify any project type that is understood by NUnit. Out of the box, this includes various Visual Studio project types as well as NUnit (.nunit) test projects (see <a href="https://github.com/nunit/docs/wiki/NUnit-Test-Projects">NUnit Test Projects</a> for a description of NUnit test projects).</p><p>If the NUnit V2 framework driver is installed, test assemblies may be run based on any version of the NUnit framework beginning with 2.0. Without the V2 driver, only version 3.0 and higher tests may be run.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Clears <see cref="Nunit3Settings.Tests"/>.</i></p><p>Comma-separated list of names of tests to run or explore. This option may be repeated. Note that this option is retained for backward compatibility. The --where option can now be used instead.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Adds a single test to <see cref="Nunit3Settings.Tests"/>.</i></p><p>Comma-separated list of names of tests to run or explore. This option may be repeated. Note that this option is retained for backward compatibility. The --where option can now be used instead.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Removes a single test from <see cref="Nunit3Settings.Tests"/>.</i></p><p>Comma-separated list of names of tests to run or explore. This option may be repeated. Note that this option is retained for backward compatibility. The --where option can now be used instead.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Parameters"/> to a new dictionary.</i></p><p>A test parameter specified in the form NAME=VALUE. Multiple parameters may be specified, separated by semicolons or by repeating the --params option multiple times.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Clears <see cref="Nunit3Settings.Parameters"/>.</i></p><p>A test parameter specified in the form NAME=VALUE. Multiple parameters may be specified, separated by semicolons or by repeating the --params option multiple times.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets a parameter in <see cref="Nunit3Settings.Parameters"/>.</i></p><p>A test parameter specified in the form NAME=VALUE. Multiple parameters may be specified, separated by semicolons or by repeating the --params option multiple times.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Configuration"/>.</i></p><p>Name of a project configuration to load (e.g.: Debug).</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Process"/>.</i></p><p>Process isolation for test assemblies. Values: Single, Separate, Multiple. If not specified, defaults to Separate for a single assembly or Multiple for more than one. By default, processes are run in parallel.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.InProcess"/>.</i></p><p>This option is a synonym for --process=Single</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.InProcess"/>.</i></p><p>This option is a synonym for --process=Single</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.InProcess"/>.</i></p><p>This option is a synonym for --process=Single</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.InProcess"/>.</i></p><p>This option is a synonym for --process=Single</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Agents"/>.</i></p><p>Number of agents that may be allowed to run simultaneously assuming you are not running inprocess. If not specified, all agent processes run tests at the same time, whatever the number of assemblies. This setting is used to control running your assemblies in parallel.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Domain"/>.</i></p><p>Domain isolation for test assemblies. Values: None, Single, Multiple. If not specified, defaults to Single for a single assembly or Multiple for more than one.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Framework"/>.</i></p><p>Framework type/version to use for tests. Examples: mono, net-4.5, v4.0, 2.0, mono-4.0</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.X86"/>.</i></p><p>Run tests in a 32-bit process on 64-bit systems.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.X86"/>.</i></p><p>Run tests in a 32-bit process on 64-bit systems.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.X86"/>.</i></p><p>Run tests in a 32-bit process on 64-bit systems.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.X86"/>.</i></p><p>Run tests in a 32-bit process on 64-bit systems.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.DisposeRunners"/>.</i></p><p>Dispose each test runner after it has finished running its tests</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.DisposeRunners"/>.</i></p><p>Dispose each test runner after it has finished running its tests</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.DisposeRunners"/>.</i></p><p>Dispose each test runner after it has finished running its tests</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.DisposeRunners"/>.</i></p><p>Dispose each test runner after it has finished running its tests</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Timeout"/>.</i></p><p>Set timeout for each test case in milliseconds.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Seed"/>.</i></p><p>Set the random seed used to generate test cases.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Workers"/>.</i></p><p>Specify the number of worker threads to be used in running tests. This setting is used to control running your tests in parallel and is used in conjunction with the Parallelizable Attribute. If not specified, workers defaults to the number of processors on the machine, or 2, whichever is greater.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.StopOnError"/>.</i></p><p>Stop run immediately upon any test failure or error.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.StopOnError"/>.</i></p><p>Stop run immediately upon any test failure or error.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.StopOnError"/>.</i></p><p>Stop run immediately upon any test failure or error.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.StopOnError"/>.</i></p><p>Stop run immediately upon any test failure or error.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.SkipNonTestAssemblies"/>.</i></p><p>Skip any non-test assemblies specified, without error.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.SkipNonTestAssemblies"/>.</i></p><p>Skip any non-test assemblies specified, without error.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.SkipNonTestAssemblies"/>.</i></p><p>Skip any non-test assemblies specified, without error.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.SkipNonTestAssemblies"/>.</i></p><p>Skip any non-test assemblies specified, without error.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Debug"/>.</i></p><p>Causes NUnit to break into the debugger immediately before it executes your tests. This is particularly useful when the tests are running in a separate process to which you would otherwise have to attach.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.Debug"/>.</i></p><p>Causes NUnit to break into the debugger immediately before it executes your tests. This is particularly useful when the tests are running in a separate process to which you would otherwise have to attach.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.Debug"/>.</i></p><p>Causes NUnit to break into the debugger immediately before it executes your tests. This is particularly useful when the tests are running in a separate process to which you would otherwise have to attach.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.Debug"/>.</i></p><p>Causes NUnit to break into the debugger immediately before it executes your tests. This is particularly useful when the tests are running in a separate process to which you would otherwise have to attach.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.DebugAgent"/>.</i></p><p>Available only in debug builds of NUnit, this option is for use by developers in debugging the nunit-agent itself. It breaks in the agent code immediately upon entry of the process.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.DebugAgent"/>.</i></p><p>Available only in debug builds of NUnit, this option is for use by developers in debugging the nunit-agent itself. It breaks in the agent code immediately upon entry of the process.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.DebugAgent"/>.</i></p><p>Available only in debug builds of NUnit, this option is for use by developers in debugging the nunit-agent itself. It breaks in the agent code immediately upon entry of the process.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.DebugAgent"/>.</i></p><p>Available only in debug builds of NUnit, this option is for use by developers in debugging the nunit-agent itself. It breaks in the agent code immediately upon entry of the process.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Pause"/>.</i></p><p>Causes NUnit to immediately open a message box, allowing you to attach a debugger. For cases where --debug does not work.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.Pause"/>.</i></p><p>Causes NUnit to immediately open a message box, allowing you to attach a debugger. For cases where --debug does not work.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.Pause"/>.</i></p><p>Causes NUnit to immediately open a message box, allowing you to attach a debugger. For cases where --debug does not work.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.Pause"/>.</i></p><p>Causes NUnit to immediately open a message box, allowing you to attach a debugger. For cases where --debug does not work.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Wait"/>.</i></p><p>Wait for input before closing console window.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.Wait"/>.</i></p><p>Wait for input before closing console window.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.Wait"/>.</i></p><p>Wait for input before closing console window.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.Wait"/>.</i></p><p>Wait for input before closing console window.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.WorkPath"/>.</i></p><p>Path of the directory to use for output files.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.OutputFile"/>.</i></p><p>File path to contain text output from the tests.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.ErrorFile"/>.</i></p><p>File path to contain error output from the tests.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Results"/> to a new list.</i></p><p>An output spec for saving the test results. This option may be repeated.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Clears <see cref="Nunit3Settings.Results"/>.</i></p><p>An output spec for saving the test results. This option may be repeated.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Adds a single result to <see cref="Nunit3Settings.Results"/>.</i></p><p>An output spec for saving the test results. This option may be repeated.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Removes a single result from <see cref="Nunit3Settings.Results"/>.</i></p><p>An output spec for saving the test results. This option may be repeated.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Clears <see cref="Nunit3Settings.Explores"/>.</i></p><p>Display or save test info rather than running tests. Optionally provide an output spec for saving the test info. This option may be repeated.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Adds a single explore to <see cref="Nunit3Settings.Explores"/>.</i></p><p>Display or save test info rather than running tests. Optionally provide an output spec for saving the test info. This option may be repeated.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Removes a single explore from <see cref="Nunit3Settings.Explores"/>.</i></p><p>Display or save test info rather than running tests. Optionally provide an output spec for saving the test info. This option may be repeated.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.NoResults"/>.</i></p><p>Don't save any test results.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.NoResults"/>.</i></p><p>Don't save any test results.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.NoResults"/>.</i></p><p>Don't save any test results.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Labels"/>.</i></p><p>Specify whether to write test case names to the output. Values: Off, On, All</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Trace"/>.</i></p><p>Set internal trace LEVEL. Values: Off, Error, Warning, Info, Verbose (Debug)</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.Encoding"/>.</i></p><p>Specify the console codepage, such as utf-8, ascii, etc. This option is not normally needed unless your output includes special characters. The page specified must be available on the system.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.ShadowCopy"/>.</i></p><p>Tells .NET to copy loaded assemblies to the shadowcopy directory.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.ShadowCopy"/>.</i></p><p>Tells .NET to copy loaded assemblies to the shadowcopy directory.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.ShadowCopy"/>.</i></p><p>Tells .NET to copy loaded assemblies to the shadowcopy directory.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.ShadowCopy"/>.</i></p><p>Tells .NET to copy loaded assemblies to the shadowcopy directory.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.TeamCity"/>.</i></p><p>Turns on use of TeamCity service messages.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.TeamCity"/>.</i></p><p>Turns on use of TeamCity service messages.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.TeamCity"/>.</i></p><p>Turns on use of TeamCity service messages.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.TeamCity"/>.</i></p><p>Turns on use of TeamCity service messages.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.LoadUserProfile"/>.</i></p><p>Causes the user profile to be loaded in any separate test processes.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.LoadUserProfile"/>.</i></p><p>Causes the user profile to be loaded in any separate test processes.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.LoadUserProfile"/>.</i></p><p>Causes the user profile to be loaded in any separate test processes.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.LoadUserProfile"/>.</i></p><p>Causes the user profile to be loaded in any separate test processes.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.ListExtensions"/>.</i></p><p>Lists all extension points and the extensions installed on each of them.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.ListExtensions"/>.</i></p><p>Lists all extension points and the extensions installed on each of them.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.ListExtensions"/>.</i></p><p>Lists all extension points and the extensions installed on each of them.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.ListExtensions"/>.</i></p><p>Lists all extension points and the extensions installed on each of them.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.SetPrincipalPolicy"/>.</i></p><p>Set the principal policy for the test domain to POLICY. Values: UnauthenticatedPrincipal, NoPrincipal, WindowsPrincipal</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.NoHeader"/>.</i></p><p>Suppress display of program information at start of run.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.NoHeader"/>.</i></p><p>Suppress display of program information at start of run.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.NoHeader"/>.</i></p><p>Suppress display of program information at start of run.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.NoHeader"/>.</i></p><p>Suppress display of program information at start of run.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="Nunit3Settings.NoColor"/>.</i></p><p>Displays console output without color.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="Nunit3Settings.NoColor"/>.</i></p><p>Displays console output without color.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="Nunit3Settings.NoColor"/>.</i></p><p>Displays console output without color.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="Nunit3Settings.NoColor"/>.</i></p><p>Displays console output without color.</p></summary>
        [Pure]
