...
namespace Nuke.Common.Tools.ReportGenerator
{
    ...
    public static partial class ReportGeneratorTasks
    {
        ...
        public static IEnumerable<string> ReportGenerator(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(ReportGeneratorPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
