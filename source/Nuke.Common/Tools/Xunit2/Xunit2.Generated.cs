...
namespace Nuke.Common.Tools.Xunit2
{
    ...
    public static partial class Xunit2SettingsExtensions
    {
        ...
        /// <summary><p><em>Adds a methods to the existing <see cref="Xunit2Settings.Methods"/>.</em></p><p>Run a given test method (should be fully specified; i.e., 'MyNamespace.MyClass.MyTestMethod').</p></summary>
        [Pure]
        ...
        /// <summary><p><em>Adds a single method to <see cref="Xunit2Settings.Methods"/>.</em></p><p>Run a given test method (should be fully specified; i.e., 'MyNamespace.MyClass.MyTestMethod').</p></summary>
        [Pure]
        ...
        /// <summary><p><em>Removes a single method from <see cref="Xunit2Settings.Methods"/>.</em></p><p>Run a given test method (should be fully specified; i.e., 'MyNamespace.MyClass.MyTestMethod').</p></summary>
        [Pure]
        ...
        /// <summary><p><em>Adds a classes to the existing <see cref="Xunit2Settings.Classes"/>.</em></p><p>Run all methods in a given test class (should be fully specified; i.e., 'MyNamespace.MyClass').</p></summary>
        [Pure]
        ...
        /// <summary><p><em>Adds a single classe to <see cref="Xunit2Settings.Classes"/>.</em></p><p>Run all methods in a given test class (should be fully specified; i.e., 'MyNamespace.MyClass').</p></summary>
        [Pure]
        ...
        /// <summary><p><em>Removes a single classe from <see cref="Xunit2Settings.Classes"/>.</em></p><p>Run all methods in a given test class (should be fully specified; i.e., 'MyNamespace.MyClass').</p></summary>
        [Pure]
        ...
        /// <summary><p><em>Adds a nss to the existing <see cref="Xunit2Settings.Namespaces"/>.</em></p><p>Run all methods in a given namespace (i.e., 'MyNamespace.MySubNamespace').</p></summary>
        [Pure]
        ...
        /// <summary><p><em>Adds a single ns to <see cref="Xunit2Settings.Namespaces"/>.</em></p><p>Run all methods in a given namespace (i.e., 'MyNamespace.MySubNamespace').</p></summary>
        [Pure]
        ...
        /// <summary><p><em>Removes a single ns from <see cref="Xunit2Settings.Namespaces"/>.</em></p><p>Run all methods in a given namespace (i.e., 'MyNamespace.MySubNamespace').</p></summary>
        [Pure]
