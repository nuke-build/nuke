...
namespace Nuke.Common.Tools.DotCover
{
    ...
    {
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.TestAction"/>.</i></p><p>The action that executes tests.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.TargetExecutable"/>.</i></p><p>File name of the program to analyse.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.TargetArguments"/>.</i></p><p>Program arguments.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.TargetWorkingDirectory"/>.</i></p><p>Program working directory.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.TempDirectory"/>.</i></p><p>Directory for auxiliary files. Set to the system temp by default.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.ReportType"/>.</i></p><p>A type of the report. XML by default.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.OutputFile"/>.</i></p><p>Resulting report file name.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.InheritConsole"/>.</i></p><p>Lets the analysed application to inherit dotCover console. The default is <c>true</c>. Please note that windows of the analysed GUI application will not be hidden if the console is inherited.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="DotCoverAnalyseSettings.InheritConsole"/>.</i></p><p>Lets the analysed application to inherit dotCover console. The default is <c>true</c>. Please note that windows of the analysed GUI application will not be hidden if the console is inherited.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="DotCoverAnalyseSettings.InheritConsole"/>.</i></p><p>Lets the analysed application to inherit dotCover console. The default is <c>true</c>. Please note that windows of the analysed GUI application will not be hidden if the console is inherited.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="DotCoverAnalyseSettings.InheritConsole"/>.</i></p><p>Lets the analysed application to inherit dotCover console. The default is <c>true</c>. Please note that windows of the analysed GUI application will not be hidden if the console is inherited.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.AnalyseTargetArguments"/>.</i></p><p>Specifies whether dotCover should analyse the 'target arguments' string and convert relative paths to absolute ones. The default is <c>true</c>.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="DotCoverAnalyseSettings.AnalyseTargetArguments"/>.</i></p><p>Specifies whether dotCover should analyse the 'target arguments' string and convert relative paths to absolute ones. The default is <c>true</c>.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="DotCoverAnalyseSettings.AnalyseTargetArguments"/>.</i></p><p>Specifies whether dotCover should analyse the 'target arguments' string and convert relative paths to absolute ones. The default is <c>true</c>.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="DotCoverAnalyseSettings.AnalyseTargetArguments"/>.</i></p><p>Specifies whether dotCover should analyse the 'target arguments' string and convert relative paths to absolute ones. The default is <c>true</c>.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.Scope"/> to a new list.</i></p><p>Allows including assemblies that were not loaded in the specified scope into coverage results. Ant-style patterns are supported here (e.g. <c>ProjectFolder/**/*.dll</c>).</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Clears <see cref="DotCoverAnalyseSettings.Scope"/>.</i></p><p>Allows including assemblies that were not loaded in the specified scope into coverage results. Ant-style patterns are supported here (e.g. <c>ProjectFolder/**/*.dll</c>).</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Adds a single scope to <see cref="DotCoverAnalyseSettings.Scope"/>.</i></p><p>Allows including assemblies that were not loaded in the specified scope into coverage results. Ant-style patterns are supported here (e.g. <c>ProjectFolder/**/*.dll</c>).</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Removes a single scope from <see cref="DotCoverAnalyseSettings.Scope"/>.</i></p><p>Allows including assemblies that were not loaded in the specified scope into coverage results. Ant-style patterns are supported here (e.g. <c>ProjectFolder/**/*.dll</c>).</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Clears <see cref="DotCoverAnalyseSettings.Filters"/>.</i></p><p>Specifies coverage filters using the following syntax: <c>+:module=*;class=*;function=*;</c>. Use <c>-:myassembly</c> to exclude an assembly from code coverage. Asterisk wildcard (*) is supported here.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Adds a single filter to <see cref="DotCoverAnalyseSettings.Filters"/>.</i></p><p>Specifies coverage filters using the following syntax: <c>+:module=*;class=*;function=*;</c>. Use <c>-:myassembly</c> to exclude an assembly from code coverage. Asterisk wildcard (*) is supported here.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Removes a single filter from <see cref="DotCoverAnalyseSettings.Filters"/>.</i></p><p>Specifies coverage filters using the following syntax: <c>+:module=*;class=*;function=*;</c>. Use <c>-:myassembly</c> to exclude an assembly from code coverage. Asterisk wildcard (*) is supported here.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Clears <see cref="DotCoverAnalyseSettings.AttributeFilters"/>.</i></p><p>Specifies attribute filters using the following syntax: <c>filter1;filter2;...</c>. Asterisk wildcard (*) is supported here.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Adds a single attributeFilter to <see cref="DotCoverAnalyseSettings.AttributeFilters"/>.</i></p><p>Specifies attribute filters using the following syntax: <c>filter1;filter2;...</c>. Asterisk wildcard (*) is supported here.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Removes a single attributeFilter from <see cref="DotCoverAnalyseSettings.AttributeFilters"/>.</i></p><p>Specifies attribute filters using the following syntax: <c>filter1;filter2;...</c>. Asterisk wildcard (*) is supported here.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="DotCoverAnalyseSettings.DisableDefaultFilters"/>.</i></p><p>Disables default (automatically added) filters.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="DotCoverAnalyseSettings.DisableDefaultFilters"/>.</i></p><p>Disables default (automatically added) filters.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="DotCoverAnalyseSettings.DisableDefaultFilters"/>.</i></p><p>Disables default (automatically added) filters.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.SymbolSearchPaths"/> to a new list.</i></p><p>Specifies additional symbol search paths. Paths to symbol servers (starting with <em>srv*</em> prefix) are supported here.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Clears <see cref="DotCoverAnalyseSettings.SymbolSearchPaths"/>.</i></p><p>Specifies additional symbol search paths. Paths to symbol servers (starting with <em>srv*</em> prefix) are supported here.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Adds a single symbolSearchPath to <see cref="DotCoverAnalyseSettings.SymbolSearchPaths"/>.</i></p><p>Specifies additional symbol search paths. Paths to symbol servers (starting with <em>srv*</em> prefix) are supported here.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Removes a single symbolSearchPath from <see cref="DotCoverAnalyseSettings.SymbolSearchPaths"/>.</i></p><p>Specifies additional symbol search paths. Paths to symbol servers (starting with <em>srv*</em> prefix) are supported here.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="DotCoverAnalyseSettings.AllowSymbolServerAccess"/>.</i></p><p>Allows dotCover to search for PDB files on a symbol server.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="DotCoverAnalyseSettings.AllowSymbolServerAccess"/>.</i></p><p>Allows dotCover to search for PDB files on a symbol server.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="DotCoverAnalyseSettings.AllowSymbolServerAccess"/>.</i></p><p>Allows dotCover to search for PDB files on a symbol server.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.ReturnTargetExitCode"/>.</i></p><p>Returns the exit code of the target executable in case coverage analysis succeeded.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="DotCoverAnalyseSettings.ReturnTargetExitCode"/>.</i></p><p>Returns the exit code of the target executable in case coverage analysis succeeded.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="DotCoverAnalyseSettings.ReturnTargetExitCode"/>.</i></p><p>Returns the exit code of the target executable in case coverage analysis succeeded.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="DotCoverAnalyseSettings.ReturnTargetExitCode"/>.</i></p><p>Returns the exit code of the target executable in case coverage analysis succeeded.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Sets <see cref="DotCoverAnalyseSettings.ProcessFilters"/> to a new list.</i></p><p>Specifies process filters. Syntax: <c>+:process1;-:process2</c>.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Clears <see cref="DotCoverAnalyseSettings.ProcessFilters"/>.</i></p><p>Specifies process filters. Syntax: <c>+:process1;-:process2</c>.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Adds a single processFilter to <see cref="DotCoverAnalyseSettings.ProcessFilters"/>.</i></p><p>Specifies process filters. Syntax: <c>+:process1;-:process2</c>.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Removes a single processFilter from <see cref="DotCoverAnalyseSettings.ProcessFilters"/>.</i></p><p>Specifies process filters. Syntax: <c>+:process1;-:process2</c>.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Enables <see cref="DotCoverAnalyseSettings.HideAutoProperties"/>.</i></p><p>Remove auto-implemented properties from report.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Disables <see cref="DotCoverAnalyseSettings.HideAutoProperties"/>.</i></p><p>Remove auto-implemented properties from report.</p></summary>
        [Pure]
        ...
        /// <summary><p><i>Toggles <see cref="DotCoverAnalyseSettings.HideAutoProperties"/>.</i></p><p>Remove auto-implemented properties from report.</p></summary>
        [Pure]
