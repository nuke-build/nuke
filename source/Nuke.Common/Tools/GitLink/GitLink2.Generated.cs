...
namespace Nuke.Common.Tools.GitLink
{
    ...
    public static partial class GitLinkTasks
    {
        ...
        /// </summary>
        public static void GitLink2 (Configure<GitLink2Settings> gitLink2SettingsConfigure = null, ProcessSettings processSettings = null)
        {
            gitLink2SettingsConfigure = gitLink2SettingsConfigure ?? (x => x);
            var gitLink2Settings = new GitLink2Settings();
            gitLink2Settings = gitLink2SettingsConfigure(gitLink2Settings);
