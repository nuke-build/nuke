...
namespace Nuke.Common.Tools.AzureKeyVault.Attributes
{
    ...
    public class KeyVaultCertificateAttribute : KeyVaultSecretAttribute
    {
        ...
        /// <param name="includeSecret">If set to <c>true</c> the secret of the certificate key is also obtained.</param>
        public KeyVaultCertificateAttribute(string certificateName = null, bool includeKey = true, bool includeSecret = true)
        ...
        public override object GetValue(MemberInfo member, object instance)
        {
            ...
            return !settings.IsValid(out _)
                ? null
                : KeyVaultTasks.GetCertificateBundle(CreateSettings(SecretName, settings), IncludeKey, IncludeSecret);
        }
    }
}
