...
namespace Nuke.Common.Tools.DotNet
{
    ...
    public static partial class DotNetTasks
    {
        ...
        {
            var dotNetTestSettings = configurator.InvokeSafe(new DotNetTestSettings());
        ...
        {
            var dotNetRunSettings = configurator.InvokeSafe(new DotNetRunSettings());
        ...
        {
            var dotNetRestoreSettings = configurator.InvokeSafe(new DotNetRestoreSettings());
        ...
        {
            var dotNetPackSettings = configurator.InvokeSafe(new DotNetPackSettings());
        ...
        {
            var dotNetBuildSettings = configurator.InvokeSafe(new DotNetBuildSettings());
