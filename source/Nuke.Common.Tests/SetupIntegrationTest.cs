...
namespace Nuke.Common.Tests
{
    public class SetupIntegrationTest : IntegrationTestBase
    {
        ...
        [Fact]
        //        [InlineData(1, "source", "build", null, TargetPlatform.Framework, ProjectFormat.Sdk, "*", "latest", ".", "BUILD")]
        public void Test()
        {
            CopySolutionFile();
...
",
            ...
            string buildProjectName = null)
        {
            ...
            process.OutputDataReceived += (s, e) => TestOutputHelper.WriteLine(e.Data);
            process.ErrorDataReceived += (s, e) => TestOutputHelper.WriteLine("ERROR | " + e.Data);
            process.Start();
